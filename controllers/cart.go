...
func (app *Application) RemoveFromCart() gin.HandlerFunc {
	...
	return func(c *gin.Context) {
		...
		c.IndentedJSON(200, "Removed the item from cart successfully")
...
func (app *Application) BuyFromCart() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if userQueryID == "" {
			log.Println("User does not exist")
			_ = c.AbortWithError(http.StatusBadRequest, errors.New("User ID not exists"))
		}
		...
		c.IndentedJSON(200, "Successfully placed item")
